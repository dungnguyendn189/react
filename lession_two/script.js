...
// console.log(primaryGenre, secondaryGenre, ortherGenres);

// const newGeneres = [...genres, "Epic Fantasy"];
// console.log(newGeneres);

// const updateBook = { ...book, moviePublicationData: "2001-12-1" };
...
// console.log(`The Book Has ${rangePage}`);
...
// const count = book.pages ?? true;
// count;

const getTotalReview = (book) => {
...
// update book object inthe array
